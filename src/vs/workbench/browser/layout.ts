...
export abstract class Layout extends Disposable implements IWorkbenchLayoutService {
	...
	private pearAIOverlayPartView!: ISerializableView;
	...
	protected createWorkbenchLayout(): void {
		...
		const pearAIOverlayPart = this.getPart(Parts.PEAROVERLAY_PART);
		...
		this.pearAIOverlayPartView = pearAIOverlayPart;

		// Create a new container for PearAIOverlayPart
		const pearAIOverlayPartContainer = document.createElement("div");
		pearAIOverlayPartContainer.style.position = "absolute";
		pearAIOverlayPartContainer.style.top = "0";
		pearAIOverlayPartContainer.style.left = "0";
		pearAIOverlayPartContainer.style.right = "0";
		pearAIOverlayPartContainer.style.bottom = "0";
		pearAIOverlayPartContainer.style.zIndex = "-10";
		pearAIOverlayPartContainer.style.display = "absolute";
		pearAIOverlayPartContainer.classList.add("pearoverlay-part-container");
		pearAIOverlayPartContainer.style.backgroundColor = 'var(--vscode-editor-background)';

		this.mainContainer.appendChild(pearAIOverlayPartContainer);
		pearAIOverlayPart.create(pearAIOverlayPartContainer);
		...
		const viewMap = {
			...
			[Parts.PEAROVERLAY_PART]: this.pearAIOverlayPartView,
		};
	...
	layout(): void {
		if (!this.disposed) {
			...
			this.pearAIOverlayPartView.layout(this._mainContainerDimension.width, this._mainContainerDimension.height, 0, 0);
