...
import { ActivePearAIAuxiliaryContext, PearAIAuxiliaryBarFocusContext } from '../../../../common/contextkeys.js';
...
import { TogglePearAIAuxiliaryBarAction } from './auxiliaryBarActions.js';
...
export class PearAIAuxiliaryBarPart extends AbstractPaneCompositePart {

	static readonly activePanelSettingsKey = 'workbench.pearaiauxiliarybar.activepanelid';
	static readonly pinnedPanelsKey = 'workbench.pearaiauxiliarybar.pinnedPanels';
	static readonly placeholdeViewContainersKey = 'workbench.pearaiauxiliarybar.placeholderPanels';
	static readonly viewContainersWorkspaceStateKey = 'workbench.pearaiauxiliarybar.viewContainersWorkspaceState';
	...
	constructor(
		...
		super(
			...
			PearAIAuxiliaryBarPart.activePanelSettingsKey,
			ActivePearAIAuxiliaryContext.bindTo(contextKeyService),
			PearAIAuxiliaryBarFocusContext.bindTo(contextKeyService),
			'pearaiauxiliarybar',
			'pearaiauxiliarybar',
			undefined,
	...
	protected getCompositeBarOptions(): IPaneCompositeBarOptions {
		const $this = this;
		return {
			partContainerClass: 'pearaiauxiliarybar',
			pinnedViewContainersKey: PearAIAuxiliaryBarPart.pinnedPanelsKey,
			placeholderViewContainersKey: PearAIAuxiliaryBarPart.placeholdeViewContainersKey,
			viewContainersWorkspaceStateKey: PearAIAuxiliaryBarPart.viewContainersWorkspaceStateKey,
			icon: true,
	...
	private fillExtraContextMenuActions(actions: IAction[]): void {
		...
		actions.push(...[
			...
			toAction({ id: TogglePearAIAuxiliaryBarAction.ID, label: localize('hide second side bar', "Hide PearAI Side Bar"), run: () => this.commandService.executeCommand(TogglePearAIAuxiliaryBarAction.ID) })
		]);
	}
	...
	private headerActionViewItemProvider(action: IAction, options: IActionViewItemOptions): IActionViewItem | undefined {
		if (action.id === TogglePearAIAuxiliaryBarAction.ID) {
	...
	override toJSON(): object {
		return {
			type: Parts.PEARAI_AUXILIARYBAR_PART
		};
	}
}
