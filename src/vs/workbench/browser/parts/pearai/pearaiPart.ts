...
export class PearAIPart extends Part {
	static readonly ID = "workbench.parts.pearai";
	...
	protected override createContentArea(element: HTMLElement): HTMLElement {
		...
		this.fullScreenOverlay = element; // use the pearaiPart root element as the fullScreenOverlay
