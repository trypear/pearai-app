...
export class AgentOverlayPart extends Part {
	static readonly ID = "workbench.parts.agentoverlay";
	...
	protected override createContentArea(element: HTMLElement): HTMLElement {
		...
		if (this.isFirstLaunch) {
			...
			loadingText.textContent = 'this is agent overlay...';
