...
import { TogglePearAIAction } from 'vs/workbench/browser/parts/pearai/pearaiActions';
...
const pearaiIcon = registerIcon('pearai', Codicon.circleFilled, localize('pearaiIcon', "Represents the PearAI popup"));
...
ToggleVisibilityActions.push(...[
	...
	CreateToggleLayoutItem(TogglePearAIAction.ID, PearAIVisibleContext, 'PearAI', pearaiIcon)
]);
